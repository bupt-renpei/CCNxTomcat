...
public class Connector implements Lifecycle, MBeanRegistration {
	 ...
	 * 
	 * @param emptySessionPath
	 *            The new "empty session path" flag value
	 */
	...
	public String getProtocol() {
		...
		if ("org.apache.coyote.http11.Http11Protocol"
				...
				|| "org.apache.coyote.http11.Http11AprProtocol"
						.equals(getProtocolHandlerClassName())) {
			return "HTTP/1.1";
		} else if ("org.apache.jk.server.JkCoyoteHandler"
				.equals(getProtocolHandlerClassName())
				|| "org.apache.coyote.ajp.AjpAprProtocol"
						.equals(getProtocolHandlerClassName())) {
			return "AJP/1.3";
		} else if ("ccntomcat.CCNProtocol"
				.equals(getProtocolHandlerClassName())) {
			return "CCN/1.0";
		}
	...
	public void setProtocol(String protocol) {
		...
		if (AprLifecycleListener.isAprAvailable()) {
			...
			} else if ("CCN/1.0".equals(protocol)) {
				setProtocolHandlerClassName("ccntomcat.CCNProtocol");
			} else if (protocol != null) {
				setProtocolHandlerClassName(protocol);
			}
		}

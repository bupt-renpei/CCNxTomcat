...
public class CoyoteAdapter implements Adapter {
    ...
    public void service(org.apache.coyote.Request req, 
        ...
        try {
            ...
            if (!comet) {
            //	System.out.println(response.getContentCount()); 	
            //	System.out.println(response.getHeaderValues(null));
            //	System.out.println("outputbuffer size is "+response.outputBuffer.getBytesWritten());
            	// add ccn response
            	// response.outputbuffer.bb contains the content

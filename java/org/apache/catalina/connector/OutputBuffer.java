...
public class OutputBuffer extends Writer
    ...
    public void close()
      ...
      //  System.out.println("bb length "+bb.getLength());
       // System.out.println("coyoteResponse writen "+coyoteResponse.getBytesWritten());
        //System.out.println("coyoteResponse ContentLength "+coyoteResponse.getContentLength());
        // nan: doFlush contain CCN handle branches, CCN handle module copy the content chunk into 
        // nan: InternalOutputBuffer.buf
        doFlush(false);
        closed = true;
    ...
    protected void doFlush(boolean realFlush)
        ...
        try {
            ...
            if (bb.getLength() > 0) {
            	//nan: append the content bytes after header bytes in internalOutputBuffer instance
                bb.flushBuffer();
            }
        } finally {
            doFlush = false;
	...
	throws IOException {
        ...
        if (cnt > 0) {
            ...
            try {
            	//nan add content data after header in outputChunk
            	//nan add content data after header in outputChunk

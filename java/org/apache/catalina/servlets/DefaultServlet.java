...
public class DefaultServlet
    ...
    protected void doGet(HttpServletRequest request,
    	 ...
    	 * nan
    	 * 
    	 * set the defaultServelet FLAG as true. CCN has different outputstream strategy for static file and dynamic request.
    	 */
    	/*
    	ResponseFacade res = (ResponseFacade)response;
    	res.setIsDefaultServerlet(true);    	
        */
        //-------------------------
    ...
    protected void serveResource(HttpServletRequest request,
        ...
        // Identify the requested resource pathx`
        ...
        if (!cacheEntry.exists) {
            ...
            System.out.println("the request Line is "+request.getRequestURI());
            System.out.println("---------------------------------------------");
    ...
    protected void copy(CacheEntry cacheEntry, InputStream is,
        ...
        if (cacheEntry.resource != null) {
            ...
            if (buffer != null) {
            	//nan: ostream == CoyoteOutputstream when request tomcat.gif
            	//nan: write bufer data to ostream bufer, ostream has it's own data structure.
                ostream.write(buffer, 0, buffer.length);
                return;
            }
            //nan: when the file is big than max size.

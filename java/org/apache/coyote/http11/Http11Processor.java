...
public class Http11Processor implements ActionHook {
    ...
    public void process(Socket theSocket)
        ...
        while (started && !error && keepAlive && !endpoint.isPaused()) {
            ...
            try {
                ...
                //nan: parese the fist line such as: 
                //GET /servlet/LoginServlet?LoginForm_email=zyuan%40gmail.com&LoginForm_password=123456 HTTP/1.1
    ...
    protected void prepareResponse() {
		...
		/**
		 *nan: send below header info 
		Accept-Ranges: bytes
		ETag: W/"7448-1370155250000"
		Last-Modified: Sun, 02 Jun 2013 06:40:50 GMT

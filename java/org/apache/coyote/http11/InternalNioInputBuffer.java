...
public class InternalNioInputBuffer implements InputBuffer {
     ...
     */
  //  public boolean parseRequestLine(boolean useAvailableDataOnly, Http11NioProcessor processor)
   //     throws IOException {
        ...
        if (parsingRequestLinePhase == 4) {
            ...
            if (parsingRequestLineQPos >= 0) {
              ...
              //  System.out.println(processor.getRequest().requestURI().toString());
            }
        ...
        if (parsingRequestLinePhase == 6) { 
            ...
            if ( (end - parsingRequestLineStart) > 0) {
              ...
              //  System.out.println(request.protocol().getByteChunk());

...
public class InternalOutputBuffer 
    ...
    public int doWrite(ByteChunk chunk, Response res) 
        ...
        if (!committed) {
            ...
            // set the filters accordingly.
    		//if (Constants.CCNPORT_NUM == res.getRequest().getServerPort()) {
    			
    			//add CCN header info to socketbuff
    ...
    public void realWriteBytes(byte cbuf[], int off, int len)
        throws IOException {
        if (len > 0) {
        	//System.out.println(String.valueOf(len)+" bytes has been flushed into the network by InternalOutputBuffer");
        	//if(outputStream instanceof CoyoteOutputStream){
        		//System.out.println("CoyoteOutputstream instance");
        	//}else if(outputStream instanceof SocketOutputStream){      		
        	//}       	
	...
	protected class OutputStreamOutputBuffer implements OutputBuffer {
		...
		public int doWrite(ByteChunk chunk, Response res) throws IOException {
			...
			// nan: add CCN handler, content data is in bytr form and stored in
			// chunk parameter
		/*	
			System.out.println("The server port  is "
					+ String.valueOf(res.getRequest().getServerPort()));
			...
			if (Constants.CCNPORT_NUM == res.getRequest().getServerPort()) {
				*/
				...
				/**
				 * 
				 * add CCN format file to network model
				 * 
				 * Function: 
				 * copy chunk data to 
				 * 
			...
			//}
			// System.out.println("The local port  is "+String.valueOf(res.getRequest().getLocalPort()));

	...
	<div class="container">
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-inner">
				<a class="brand" href=" ccnx://bupt/index.jsp" title="记忆犹新"
					style="padding-left: 28px;">Next Network</a>
				<ul id="navigation" class="nav">

					<li class="active"><a href=" ccnx://bupt/category/memory">首页</a></li>

					<li><a href=" ccnx://bupt//category/lover">测试1</a></li>

					<li><a href=" ccnx://bupt//category/travel">测试2</a></li>

					<li><a href=" ccnx://bupt//category/flavor">测试3</a></li>

					<li><a href=" ccnx://bupt//category/timeline">测试4</a></li>
					...
					<li>
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a href="#">个人资料</a></li>
								<li><a href="ccnx://bupt/servlet/LogoutServlet">退出</a></li>
							</ul>
						</div></li>
					<li>
            ...
            <div class="widget-content">
                <div style="margin-left: 9px">
                    <a href="#calendarModal"  data-toggle="modal">
                            <img class="img-rounded app-image" alt="100x100" style=" width: 430px; height: 150px;" src=" ccnx://bupt/img/calendarhref.png">
                    </a>
                </div>
		...
		<div class="modal-body">
			...
			<div style="text-align: center">
				<div class="btn-group"
					...
					<ul id="share" class="dropdown-menu">
						<li class="rec-sina"><a href=" ccnx://bupt/user/sina/oauth"
			...
			<form class="form-horizontal" id="login-form" action="ccnx://bupt/servlet/LoginServlet"
				...
				<fieldset>
					...
					<div style="text-align: center">
						<button type="submit" class="btn btn-info span2" onclick="refreshsite();" >登录</button>
						<a href=" ccnx://bupt/login.jsp" class="btn span2">注册</a>
					</div>
				</fieldset>
			</form>
		</div>
